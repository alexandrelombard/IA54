...
import fr.utbm.ia54.agents.EnvironmentAgent;
...
public class BootAgent extends Agent {
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info("Spawning environment and boids agents");
    ...
    final Procedure1<Agent> _function = (Agent it) -> {
      ...
      long _milliseconds = (50);
      _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(new SimulationStepEvent(_milliseconds));
    };
    _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER.every((50), _function);
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1 = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER_1.info("Creating UI");
    Application.launch(BoidsApplication.class);
  }
